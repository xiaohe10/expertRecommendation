# Django settings for expertRecommendation project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'experts',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'yv5of++o2)7x9ahy(s=jp%0)=l*rsdb@4rbh9o-rmoiz4!0tk#'
...
ROOT_URLCONF = 'expertRecommendation.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'expertRecommendation.wsgi.application'
